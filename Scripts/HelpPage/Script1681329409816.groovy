...
WebUI.click(findTestObject('Object Repository/Page_AP Storytelling Playbook/span_Help'))

WebUI.switchToWindowTitle('404 - File or directory not found.')

if (WebUI.verifyElementText(findTestObject('Object Repository/Page_404 - File or directory not found/h1_Server Error'), 
    'Server Error')) {
    ...
    String screenshotPath = ('Screenshots/HelpPage/HelpPage_' + formatDateTime) + '(CST).png'

    println(screenshotPath)

    WebUI.takeScreenshot(screenshotPath)

    println('---------- HELP PAGE SUCCESS ---------- \n\n')
}
